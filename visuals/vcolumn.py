...
map_column = html.Div(id="selectors", children=[
    ...
    html.Div(children=[
        html.P(' List of Volunteers ',  style={'margin-top': '35px', 'font-size': '14px', 'float':'left'}),
        ...
        # html.B(children=[html.A("Arka A K", href="https://github.com//ArkaAK", style={'margin-top': '35px', 'margin-left': '5px', 'font-size': '14px', 'float':'left'})]),
        # html.B(children=[html.A("Avni Hirpara", href="https://github.com/Avni-Hirpara", style={'margin-top': '35px', 'margin-left': '5px', 'font-size': '14px', 'float':'left'})]),
        # html.B(children=[html.A("Raghav Sasikanth", href="https://github.com/JZZQuant", style={'margin-top': '35px', 'margin-left': '5px', 'font-size': '14px', 'float':'left'})]),
        # html.B(children=[html.A("Sathyan Sethumadhavan", href="https://github.com/satnair", style={'margin-top': '35px', 'margin-left': '5px', 'font-size': '14px', 'float':'left'})]),
        # html.B(children=[html.A("Mahendra Yadav", href="https://github.com/userimack", style={'margin-top': '35px', 'margin-left': '5px', 'font-size': '14px', 'float':'left'})]),
        # html.B(children=[html.A("Priya", href="https://github.com/orgs/kumawatanupriya", style={'margin-top': '35px', 'margin-left': '5px', 'font-size': '14px', 'float':'left'})]),
...
def plot_graph(I, R, Severe_H, R_Fatal, rate_frac, date, cumsum, mt, node, test_per=0):
    ...
    textToday =  ["", today.strftime("%d %b")+',<br>Infected : {:,}'.format((I[todayIndex]+R[todayIndex])) + '<br>'\
                  +'Fatal : {:,}'.format((R_Fatal[todayIndex]))]
