...
map_column = html.Div(id="selectors", children=[
    ...
    html.A(children=html.Button(children='Click here for model specifications'), href='https://indiacovidmodel.in/',  style={'color': '#333','border-color': '#888','outline': '0'}),
    html.Div(html.P(['', html.Br(), ''])),
    html.Div(children=[
        html.P(u"\u00A9"+ 'Developed by ',  style={'margin-top': '48px', 'font-size': '14px', 'float':'left'}),
    ]),
    html.Div(html.Img(src=('https://ispirt.in/wp-content/themes/ispirt/img/isprit_logo.svg'), style={'margin-top': '50px','float':'left','height':'7%', 'width':'7%'})),
    html.Div(children=[
        html.P(u'Supported by ',  style={'margin-top': '50px', 'font-size': '14px', 'float':'left'}),
    ]),
    html.Div(html.Img(src=('https://www.thoughtworks.com/imgs/tw-logo.svg'), style={'margin-top': '58px','float':'left','height':'9%', 'width':'9%'})),
    html.Div(children=[
